      ...
      <div className="hero-section">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Your Intelligent Market Insight Tool for Real-time Financial
            Analysis
          </p>
          <p className="hero-description">
            Track live cryptocurrency prices, analyze market trends, and make
            informed financial decisions with our comprehensive dashboard
            powered by multiple financial APIs.
          </p>
      ...
      <div className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <p>
              Track real-time cryptocurrency prices with 24/7 market updates in
              INR
            </p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p>
              Compare short-term (24h), medium-term (7d), and long-term (30d)
              trends
            </p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p>
              Automated alerts for unusual market movements and high volatility
            </p>
          </div>
